...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[_CL] = LAYOUT_60_tsangan(
		...
		_______,          RGB_TOG, RGB_MOD, RGB_HUI, RGB_SAI, RGB_VAI, _______, KC_BTN1, KC_MS_U, KC_BTN2, _______, _______, _______, _______,
		_______,          _______, _______, RGB_HUD, RGB_SAD, RGB_VAD, _______, KC_MS_L, KC_MS_D, KC_MS_R, _______, _______, _______,
